        ...
        FlipClock.DailyCounterFace = FlipClock.Face.extend({
            ...
            build: function (b) {
                ...
                (b = b ? b : this.factory.time.getDayCounter(this.showSeconds)),
                    ...
                    this.showSeconds
                        ? a(this.createDivider("Sekundy")).insertBefore(
                            this.lists[this.lists.length - 2].$el
                        )
                        : (e = 2),
                    a(this.createDivider("Minuty")).insertBefore(
                        this.lists[this.lists.length - 4 + e].$el
                    ),
                    a(this.createDivider("Godziny")).insertBefore(
                        this.lists[this.lists.length - 6 + e].$el
                    ),
                    a(this.createDivider("Dni", !0)).insertBefore(this.lists[0].$el),
                    this.base();
            },
            flip: function (a, b) {
...
(function ($) {
    ...
    var dt1 = "5/10/" + dt.getFullYear() + " 00:00:01 am +0000";
